...
public class MyNote1Application {
	
//	@Autowired
//	private DatabaseConnector databaseConnector;

	private static final Logger LOG = LoggerFactory.getLogger(MyNote1Application.class);

	public static void main(String[] args) {
		SpringApplication.run(MyNote1Application.class, args);
	}
