...
public class ContentsRelation {
    ...
    public ContentsRelation() {
    }

    public ContentsRelation(String contentRelationId, String fromIds, String toIds, String lineType, String text,
